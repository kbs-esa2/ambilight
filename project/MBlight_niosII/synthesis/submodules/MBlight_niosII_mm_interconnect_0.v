// MBlight_niosII_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module MBlight_niosII_mm_interconnect_0 (
		...
		output wire [1:0]  led_adress_s1_address,                          //                            led_adress_s1.address
		output wire        led_adress_s1_write,                            //                                         .write
		input  wire [31:0] led_adress_s1_readdata,                         //                                         .readdata
		output wire [31:0] led_adress_s1_writedata,                        //                                         .writedata
		output wire        led_adress_s1_chipselect,                       //                                         .chipselect
		output wire [1:0]  led_control_s1_address,                         //                           led_control_s1.address
		input  wire [31:0] led_control_s1_readdata,                        //                                         .readdata
	...
	wire   [23:0] i2c_0_csr_agent_m0_address;                                                         // i2c_0_csr_agent:m0_address -> i2c_0_csr_translator:uav_address
	...
	wire  [100:0] i2c_0_csr_agent_rf_source_data;                                                     // i2c_0_csr_agent:rf_source_data -> i2c_0_csr_agent_rsp_fifo:in_data
	...
	wire  [100:0] i2c_0_csr_agent_rsp_fifo_out_data;                                                  // i2c_0_csr_agent_rsp_fifo:out_data -> i2c_0_csr_agent:rf_sink_data
	...
	wire   [99:0] cmd_mux_001_src_data;                                                               // cmd_mux_001:src_data -> i2c_0_csr_agent:cp_data
	...
	wire   [99:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> nios2_gen2_0_debug_mem_slave_agent:cp_data
	...
	wire   [99:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire   [23:0] led_data_s1_agent_m0_address;                                                       // led_data_s1_agent:m0_address -> led_data_s1_translator:uav_address
	...
	wire  [100:0] led_data_s1_agent_rf_source_data;                                                   // led_data_s1_agent:rf_source_data -> led_data_s1_agent_rsp_fifo:in_data
	...
	wire  [100:0] led_data_s1_agent_rsp_fifo_out_data;                                                // led_data_s1_agent_rsp_fifo:out_data -> led_data_s1_agent:rf_sink_data
	...
	wire          cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> led_data_s1_agent:cp_valid
	wire   [99:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> led_data_s1_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                              // led_data_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [6:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> led_data_s1_agent:cp_channel
	wire          cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> led_data_s1_agent:cp_startofpacket
	wire          cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> led_data_s1_agent:cp_endofpacket
	wire   [31:0] led_adress_s1_agent_m0_readdata;                                                    // led_adress_s1_translator:uav_readdata -> led_adress_s1_agent:m0_readdata
	wire          led_adress_s1_agent_m0_waitrequest;                                                 // led_adress_s1_translator:uav_waitrequest -> led_adress_s1_agent:m0_waitrequest
	wire          led_adress_s1_agent_m0_debugaccess;                                                 // led_adress_s1_agent:m0_debugaccess -> led_adress_s1_translator:uav_debugaccess
	wire   [23:0] led_adress_s1_agent_m0_address;                                                     // led_adress_s1_agent:m0_address -> led_adress_s1_translator:uav_address
	wire    [3:0] led_adress_s1_agent_m0_byteenable;                                                  // led_adress_s1_agent:m0_byteenable -> led_adress_s1_translator:uav_byteenable
	wire          led_adress_s1_agent_m0_read;                                                        // led_adress_s1_agent:m0_read -> led_adress_s1_translator:uav_read
	wire          led_adress_s1_agent_m0_readdatavalid;                                               // led_adress_s1_translator:uav_readdatavalid -> led_adress_s1_agent:m0_readdatavalid
	wire          led_adress_s1_agent_m0_lock;                                                        // led_adress_s1_agent:m0_lock -> led_adress_s1_translator:uav_lock
	wire   [31:0] led_adress_s1_agent_m0_writedata;                                                   // led_adress_s1_agent:m0_writedata -> led_adress_s1_translator:uav_writedata
	wire          led_adress_s1_agent_m0_write;                                                       // led_adress_s1_agent:m0_write -> led_adress_s1_translator:uav_write
	wire    [2:0] led_adress_s1_agent_m0_burstcount;                                                  // led_adress_s1_agent:m0_burstcount -> led_adress_s1_translator:uav_burstcount
	wire          led_adress_s1_agent_rf_source_valid;                                                // led_adress_s1_agent:rf_source_valid -> led_adress_s1_agent_rsp_fifo:in_valid
	wire  [100:0] led_adress_s1_agent_rf_source_data;                                                 // led_adress_s1_agent:rf_source_data -> led_adress_s1_agent_rsp_fifo:in_data
	wire          led_adress_s1_agent_rf_source_ready;                                                // led_adress_s1_agent_rsp_fifo:in_ready -> led_adress_s1_agent:rf_source_ready
	wire          led_adress_s1_agent_rf_source_startofpacket;                                        // led_adress_s1_agent:rf_source_startofpacket -> led_adress_s1_agent_rsp_fifo:in_startofpacket
	wire          led_adress_s1_agent_rf_source_endofpacket;                                          // led_adress_s1_agent:rf_source_endofpacket -> led_adress_s1_agent_rsp_fifo:in_endofpacket
	wire          led_adress_s1_agent_rsp_fifo_out_valid;                                             // led_adress_s1_agent_rsp_fifo:out_valid -> led_adress_s1_agent:rf_sink_valid
	wire  [100:0] led_adress_s1_agent_rsp_fifo_out_data;                                              // led_adress_s1_agent_rsp_fifo:out_data -> led_adress_s1_agent:rf_sink_data
	wire          led_adress_s1_agent_rsp_fifo_out_ready;                                             // led_adress_s1_agent:rf_sink_ready -> led_adress_s1_agent_rsp_fifo:out_ready
	wire          led_adress_s1_agent_rsp_fifo_out_startofpacket;                                     // led_adress_s1_agent_rsp_fifo:out_startofpacket -> led_adress_s1_agent:rf_sink_startofpacket
	wire          led_adress_s1_agent_rsp_fifo_out_endofpacket;                                       // led_adress_s1_agent_rsp_fifo:out_endofpacket -> led_adress_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> led_adress_s1_agent:cp_valid
	wire   [99:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> led_adress_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                              // led_adress_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [6:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> led_adress_s1_agent:cp_channel
	wire          cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> led_adress_s1_agent:cp_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> led_adress_s1_agent:cp_endofpacket
	wire   [31:0] led_control_s1_agent_m0_readdata;                                                   // led_control_s1_translator:uav_readdata -> led_control_s1_agent:m0_readdata
	wire          led_control_s1_agent_m0_waitrequest;                                                // led_control_s1_translator:uav_waitrequest -> led_control_s1_agent:m0_waitrequest
	wire          led_control_s1_agent_m0_debugaccess;                                                // led_control_s1_agent:m0_debugaccess -> led_control_s1_translator:uav_debugaccess
	wire   [23:0] led_control_s1_agent_m0_address;                                                    // led_control_s1_agent:m0_address -> led_control_s1_translator:uav_address
	wire    [3:0] led_control_s1_agent_m0_byteenable;                                                 // led_control_s1_agent:m0_byteenable -> led_control_s1_translator:uav_byteenable
	wire          led_control_s1_agent_m0_read;                                                       // led_control_s1_agent:m0_read -> led_control_s1_translator:uav_read
	wire          led_control_s1_agent_m0_readdatavalid;                                              // led_control_s1_translator:uav_readdatavalid -> led_control_s1_agent:m0_readdatavalid
	wire          led_control_s1_agent_m0_lock;                                                       // led_control_s1_agent:m0_lock -> led_control_s1_translator:uav_lock
	wire   [31:0] led_control_s1_agent_m0_writedata;                                                  // led_control_s1_agent:m0_writedata -> led_control_s1_translator:uav_writedata
	wire          led_control_s1_agent_m0_write;                                                      // led_control_s1_agent:m0_write -> led_control_s1_translator:uav_write
	wire    [2:0] led_control_s1_agent_m0_burstcount;                                                 // led_control_s1_agent:m0_burstcount -> led_control_s1_translator:uav_burstcount
	wire          led_control_s1_agent_rf_source_valid;                                               // led_control_s1_agent:rf_source_valid -> led_control_s1_agent_rsp_fifo:in_valid
	wire  [100:0] led_control_s1_agent_rf_source_data;                                                // led_control_s1_agent:rf_source_data -> led_control_s1_agent_rsp_fifo:in_data
	wire          led_control_s1_agent_rf_source_ready;                                               // led_control_s1_agent_rsp_fifo:in_ready -> led_control_s1_agent:rf_source_ready
	wire          led_control_s1_agent_rf_source_startofpacket;                                       // led_control_s1_agent:rf_source_startofpacket -> led_control_s1_agent_rsp_fifo:in_startofpacket
	wire          led_control_s1_agent_rf_source_endofpacket;                                         // led_control_s1_agent:rf_source_endofpacket -> led_control_s1_agent_rsp_fifo:in_endofpacket
	wire          led_control_s1_agent_rsp_fifo_out_valid;                                            // led_control_s1_agent_rsp_fifo:out_valid -> led_control_s1_agent:rf_sink_valid
	wire  [100:0] led_control_s1_agent_rsp_fifo_out_data;                                             // led_control_s1_agent_rsp_fifo:out_data -> led_control_s1_agent:rf_sink_data
	wire          led_control_s1_agent_rsp_fifo_out_ready;                                            // led_control_s1_agent:rf_sink_ready -> led_control_s1_agent_rsp_fifo:out_ready
	wire          led_control_s1_agent_rsp_fifo_out_startofpacket;                                    // led_control_s1_agent_rsp_fifo:out_startofpacket -> led_control_s1_agent:rf_sink_startofpacket
	wire          led_control_s1_agent_rsp_fifo_out_endofpacket;                                      // led_control_s1_agent_rsp_fifo:out_endofpacket -> led_control_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> led_control_s1_agent:cp_valid
	wire   [99:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> led_control_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // led_control_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [6:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> led_control_s1_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> led_control_s1_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> led_control_s1_agent:cp_endofpacket
	...
	wire   [99:0] i2c_0_csr_agent_rp_data;                                                            // i2c_0_csr_agent:rp_data -> router_003:sink_data
	...
	wire   [99:0] nios2_gen2_0_debug_mem_slave_agent_rp_data;                                         // nios2_gen2_0_debug_mem_slave_agent:rp_data -> router_004:sink_data
	...
	wire   [99:0] onchip_memory2_0_s1_agent_rp_data;                                                  // onchip_memory2_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire          led_data_s1_agent_rp_valid;                                                         // led_data_s1_agent:rp_valid -> router_006:sink_valid
	wire   [99:0] led_data_s1_agent_rp_data;                                                          // led_data_s1_agent:rp_data -> router_006:sink_data
	wire          led_data_s1_agent_rp_ready;                                                         // router_006:sink_ready -> led_data_s1_agent:rp_ready
	wire          led_data_s1_agent_rp_startofpacket;                                                 // led_data_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          led_data_s1_agent_rp_endofpacket;                                                   // led_data_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire          led_adress_s1_agent_rp_valid;                                                       // led_adress_s1_agent:rp_valid -> router_007:sink_valid
	wire   [99:0] led_adress_s1_agent_rp_data;                                                        // led_adress_s1_agent:rp_data -> router_007:sink_data
	wire          led_adress_s1_agent_rp_ready;                                                       // router_007:sink_ready -> led_adress_s1_agent:rp_ready
	wire          led_adress_s1_agent_rp_startofpacket;                                               // led_adress_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          led_adress_s1_agent_rp_endofpacket;                                                 // led_adress_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire          led_control_s1_agent_rp_valid;                                                      // led_control_s1_agent:rp_valid -> router_008:sink_valid
	wire   [99:0] led_control_s1_agent_rp_data;                                                       // led_control_s1_agent:rp_data -> router_008:sink_data
	wire          led_control_s1_agent_rp_ready;                                                      // router_008:sink_ready -> led_control_s1_agent:rp_ready
	wire          led_control_s1_agent_rp_startofpacket;                                              // led_control_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          led_control_s1_agent_rp_endofpacket;                                                // led_control_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire          led_data_s1_agent_rdata_fifo_src_valid;                                             // led_data_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire   [33:0] led_data_s1_agent_rdata_fifo_src_data;                                              // led_data_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire          led_data_s1_agent_rdata_fifo_src_ready;                                             // avalon_st_adapter_004:in_0_ready -> led_data_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> led_data_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> led_data_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_004_out_0_ready;                                                  // led_data_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire    [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> led_data_s1_agent:rdata_fifo_sink_error
	wire          led_adress_s1_agent_rdata_fifo_src_valid;                                           // led_adress_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] led_adress_s1_agent_rdata_fifo_src_data;                                            // led_adress_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire          led_adress_s1_agent_rdata_fifo_src_ready;                                           // avalon_st_adapter_005:in_0_ready -> led_adress_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_005_out_0_valid;                                                  // avalon_st_adapter_005:out_0_valid -> led_adress_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_005_out_0_data;                                                   // avalon_st_adapter_005:out_0_data -> led_adress_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                                  // led_adress_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                                  // avalon_st_adapter_005:out_0_error -> led_adress_s1_agent:rdata_fifo_sink_error
	wire          led_control_s1_agent_rdata_fifo_src_valid;                                          // led_control_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] led_control_s1_agent_rdata_fifo_src_data;                                           // led_control_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          led_control_s1_agent_rdata_fifo_src_ready;                                          // avalon_st_adapter_006:in_0_ready -> led_control_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> led_control_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> led_control_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                                  // led_control_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> led_control_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) led_adress_s1_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (led_adress_s1_agent_m0_address),                 // avalon_universal_slave_0.address
		.uav_burstcount         (led_adress_s1_agent_m0_burstcount),              //                         .burstcount
		.uav_read               (led_adress_s1_agent_m0_read),                    //                         .read
		.uav_write              (led_adress_s1_agent_m0_write),                   //                         .write
		.uav_waitrequest        (led_adress_s1_agent_m0_waitrequest),             //                         .waitrequest
		.uav_readdatavalid      (led_adress_s1_agent_m0_readdatavalid),           //                         .readdatavalid
		.uav_byteenable         (led_adress_s1_agent_m0_byteenable),              //                         .byteenable
		.uav_readdata           (led_adress_s1_agent_m0_readdata),                //                         .readdata
		.uav_writedata          (led_adress_s1_agent_m0_writedata),               //                         .writedata
		.uav_lock               (led_adress_s1_agent_m0_lock),                    //                         .lock
		.uav_debugaccess        (led_adress_s1_agent_m0_debugaccess),             //                         .debugaccess
		.av_address             (led_adress_s1_address),                          //      avalon_anti_slave_0.address
		.av_write               (led_adress_s1_write),                            //                         .write
		.av_readdata            (led_adress_s1_readdata),                         //                         .readdata
		.av_writedata           (led_adress_s1_writedata),                        //                         .writedata
		.av_chipselect          (led_adress_s1_chipselect),                       //                         .chipselect
		.av_read                (),                                               //              (terminated)
		.av_begintransfer       (),                                               //              (terminated)
		.av_beginbursttransfer  (),                                               //              (terminated)
		.av_burstcount          (),                                               //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) led_control_s1_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (led_control_s1_agent_m0_address),                // avalon_universal_slave_0.address
		.uav_burstcount         (led_control_s1_agent_m0_burstcount),             //                         .burstcount
		.uav_read               (led_control_s1_agent_m0_read),                   //                         .read
		.uav_write              (led_control_s1_agent_m0_write),                  //                         .write
		.uav_waitrequest        (led_control_s1_agent_m0_waitrequest),            //                         .waitrequest
		.uav_readdatavalid      (led_control_s1_agent_m0_readdatavalid),          //                         .readdatavalid
		.uav_byteenable         (led_control_s1_agent_m0_byteenable),             //                         .byteenable
		.uav_readdata           (led_control_s1_agent_m0_readdata),               //                         .readdata
		.uav_writedata          (led_control_s1_agent_m0_writedata),              //                         .writedata
		.uav_lock               (led_control_s1_agent_m0_lock),                   //                         .lock
		.uav_debugaccess        (led_control_s1_agent_m0_debugaccess),            //                         .debugaccess
		.av_address             (led_control_s1_address),                         //      avalon_anti_slave_0.address
		.av_readdata            (led_control_s1_readdata),                        //                         .readdata
		.av_write               (),                                               //              (terminated)
		.av_read                (),                                               //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                  //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (led_adress_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (led_adress_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (led_adress_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (led_adress_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (led_adress_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (led_adress_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (led_adress_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (led_adress_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (led_adress_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (led_adress_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (led_adress_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (led_adress_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (led_adress_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (led_adress_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (led_adress_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (led_adress_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (led_adress_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (led_adress_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (led_adress_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (led_adress_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (led_adress_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (led_adress_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (led_adress_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (led_adress_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (led_adress_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (led_adress_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_005_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_005_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_005_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_005_out_0_error),              //                .error
		.rdata_fifo_src_ready    (led_adress_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (led_adress_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (led_adress_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) led_adress_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                  //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (led_adress_s1_agent_rf_source_data),             //        in.data
		.in_valid          (led_adress_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (led_adress_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (led_adress_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (led_adress_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (led_adress_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (led_adress_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (led_adress_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (led_adress_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (led_adress_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) led_control_s1_agent (
		.clk                     (clk_0_clk_clk),                                   //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset),  //       clk_reset.reset
		.m0_address              (led_control_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (led_control_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (led_control_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (led_control_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (led_control_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (led_control_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (led_control_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (led_control_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (led_control_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (led_control_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (led_control_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (led_control_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (led_control_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (led_control_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (led_control_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (led_control_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (led_control_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (led_control_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (led_control_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (led_control_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (led_control_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (led_control_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (led_control_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (led_control_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (led_control_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (led_control_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_006_out_0_ready),               // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_006_out_0_valid),               //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_006_out_0_data),                //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_006_out_0_error),               //                .error
		.rdata_fifo_src_ready    (led_control_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (led_control_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (led_control_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                           //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                             //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) led_control_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                   //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset),  // clk_reset.reset
		.in_data           (led_control_s1_agent_rf_source_data),             //        in.data
		.in_valid          (led_control_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (led_control_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (led_control_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (led_control_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (led_control_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (led_control_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (led_control_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (led_control_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (led_control_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                           // (terminated)
		.csr_read          (1'b0),                                            // (terminated)
		.csr_write         (1'b0),                                            // (terminated)
		.csr_readdata      (),                                                // (terminated)
	...
	MBlight_niosII_mm_interconnect_0_router router (
	...
	MBlight_niosII_mm_interconnect_0_router_001 router_001 (
	...
	MBlight_niosII_mm_interconnect_0_router_002 router_002 (
	...
	MBlight_niosII_mm_interconnect_0_router_002 router_003 (
	...
	MBlight_niosII_mm_interconnect_0_router_004 router_004 (
	...
	MBlight_niosII_mm_interconnect_0_router_004 router_005 (
	...
	MBlight_niosII_mm_interconnect_0_router_002 router_006 (
	...
	MBlight_niosII_mm_interconnect_0_router_002 router_007 (
		.sink_ready         (led_adress_s1_agent_rp_ready),                   //      sink.ready
		.sink_valid         (led_adress_s1_agent_rp_valid),                   //          .valid
		.sink_data          (led_adress_s1_agent_rp_data),                    //          .data
		.sink_startofpacket (led_adress_s1_agent_rp_startofpacket),           //          .startofpacket
		.sink_endofpacket   (led_adress_s1_agent_rp_endofpacket),             //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MBlight_niosII_mm_interconnect_0_router_002 router_008 (
		.sink_ready         (led_control_s1_agent_rp_ready),                  //      sink.ready
		.sink_valid         (led_control_s1_agent_rp_valid),                  //          .valid
		.sink_data          (led_control_s1_agent_rp_data),                   //          .data
		.sink_startofpacket (led_control_s1_agent_rp_startofpacket),          //          .startofpacket
		.sink_endofpacket   (led_control_s1_agent_rp_endofpacket),            //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MBlight_niosII_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MBlight_niosII_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MBlight_niosII_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MBlight_niosII_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MBlight_niosII_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MBlight_niosII_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MBlight_niosII_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MBlight_niosII_mm_interconnect_0_cmd_mux cmd_mux_005 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MBlight_niosII_mm_interconnect_0_cmd_mux cmd_mux_006 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MBlight_niosII_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MBlight_niosII_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MBlight_niosII_mm_interconnect_0_cmd_demux_001 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MBlight_niosII_mm_interconnect_0_cmd_demux_001 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MBlight_niosII_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MBlight_niosII_mm_interconnect_0_rsp_demux rsp_demux_005 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MBlight_niosII_mm_interconnect_0_rsp_demux rsp_demux_006 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MBlight_niosII_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MBlight_niosII_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MBlight_niosII_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
	...
	MBlight_niosII_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (led_adress_s1_agent_rdata_fifo_src_data),        //     in_0.data
		.in_0_valid     (led_adress_s1_agent_rdata_fifo_src_valid),       //         .valid
		.in_0_ready     (led_adress_s1_agent_rdata_fifo_src_ready),       //         .ready
	...
	MBlight_niosII_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (led_control_s1_agent_rdata_fifo_src_data),       //     in_0.data
		.in_0_valid     (led_control_s1_agent_rdata_fifo_src_valid),      //         .valid
		.in_0_ready     (led_control_s1_agent_rdata_fifo_src_ready),      //         .ready
