...
void setLed(int index, color pixel);
void drawTaskBar();
...
int main(void)
{
  ...
  {
    setLed(i, colorFromHex(0x00000000));
  }
  setLed(0, colorFromHex(0xff100000));
...
void getAverages()
{
  ...
  { //i = frameblock nmr
    for (unsigned int j = 0; j < leftEdge.frameBlock[i].Height; j++)
    { //j = y waarde
      for (unsigned int k = 0; k < leftEdge.frameBlock[i].Width; k++)
      { //k = x waarde
  ...
  { //i = frameblock nmr
    for (unsigned int j = 0; j < topEdge.frameBlock[i].Height; j++)
    { //j = y waarde
      for (unsigned int k = 0; k < topEdge.frameBlock[i].Width; k++)
      { //k = x waarde
  ...
  { //i = frameblock nmr
    for (unsigned int j = 0; j < rightEdge.frameBlock[i].Height; j++)
    { //j = y waarde
      for (unsigned int k = 0; k < rightEdge.frameBlock[i].Width; k++)
      { //k = x waarde
  ...
  { //i = frameblock nmr
    for (unsigned int j = 0; j < bottomEdge.frameBlock[i].Height; j++)
    { //j = y waarde
      for (unsigned int k = 0; k < bottomEdge.frameBlock[i].Width; k++)
      { //k = x waarde
